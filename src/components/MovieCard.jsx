      ...
      {movie.backdrop_path &&
        <div className='relative group'>
          <div className='hover:scale-105 duration-500 '>
            <img onClick={handleClick} className='max-w-sm rounded-md cursor-pointer w-40 lg:w-96' src={baseUrlImages + (isLargeImage ? movie.poster_path : movie.backdrop_path)} alt="" />
