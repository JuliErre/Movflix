...
<>
        {visible &&
        <div key={movie.id} className={`fixed z-20  w-full h-full bg-black/50 top-0 left-0 flex flex-col items-center justify-center  `} >
                    ...
                    <div className='flex flex-row justify-between gap-5'>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row  gap-1'>
                                <span className=' text- text-gray-600 font-semi-bold'>Release Date:</span>
                                <h5 className='text-white text-l font-semi-bold'> {movie.release_date}</h5>
                            </div>
                            <div className='flex flex-row gap-1'>
                                <span className=' text- text-gray-600 font-semi-bold'>Actors:</span>
